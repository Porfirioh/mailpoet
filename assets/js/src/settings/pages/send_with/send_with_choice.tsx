...
export default function SendWithChoice() {
  ...
  return (
    <ul className="mailpoet-sending-methods">
      <li>
        <label onClick={mssChosen} className="mailpoet-sending-method mailpoet-form-checkbox">
          <input type="radio" checked={isMssActive} />
          ...
          {!isMssKeyValid && !isPremiumKeyValid && (
            <div className="mailpoet-sending-method-actions">
              ...
              <a href="#/premium" className="mailpoet-link">
      ...
      <li>
        <label onClick={otherChosen} className="mailpoet-sending-method mailpoet-form-checkbox">
          <input type="radio" checked={!isMssActive} />
          <span className="mailpoet-form-radio-control" />
